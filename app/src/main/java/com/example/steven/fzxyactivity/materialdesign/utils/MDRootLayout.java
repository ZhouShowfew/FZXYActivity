package com.example.steven.fzxyactivity.materialdesign.utils;
...
public class MDRootLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNoTitlePaddingFull = r.getDimensionPixelSize(R.dimen.space_16dp);
        mButtonPaddingFull = r.getDimensionPixelSize(R.dimen.space_8dp);

        mButtonHorizontalEdgeMargin = r.getDimensionPixelSize(R.dimen.icon_48dp);
        mButtonBarHeight = r.getDimensionPixelSize(R.dimen.icon_48dp);

        mDividerPaint = new Paint();
        mDividerWidth = r.getDimensionPixelSize(R.dimen.line_width_1dp);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!mForceStack) {
            ...
            int buttonBarPadding = getContext().getResources()
                    .getDimensionPixelSize(R.dimen.prompt);
