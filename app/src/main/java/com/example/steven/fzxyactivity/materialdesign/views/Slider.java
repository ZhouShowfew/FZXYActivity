...
public class Slider extends CustomView {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (numberIndicator != null) {
                        ...
                        numberIndicator.indicator.finalY = MDUtils
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value == min) {
            ...
            paint.setStrokeWidth(MDUtils.dpToPx(2, getResources()));
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        // Set size of view
        setMinimumHeight(MDUtils.dpToPx(48, getResources()));
        setMinimumWidth(MDUtils.dpToPx(80, getResources()));
        ...
        LayoutParams params = new LayoutParams(MDUtils.dpToPx(20,
                getResources()), MDUtils.dpToPx(20, getResources()));
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (animate) {
                ...
                y -= MDUtils.dpToPx(6, getResources());
                size += MDUtils.dpToPx(2, getResources());
            }
            canvas.drawCircle(
                    ViewHelper.getX(ball)
                            + MDUtils.getRelativeLeft((View) ball.getParent())
            ...
            if (animate == false) {
                ViewHelper
                        .setX(numberIndicator.numberIndicator,
                                (ViewHelper.getX(ball)
                                        + MDUtils.getRelativeLeft((View) ball
