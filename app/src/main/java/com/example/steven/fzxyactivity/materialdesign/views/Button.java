...
public abstract class Button extends CustomView {
	...
	protected void setDefaultProperties() {
		// Min size
		setMinimumHeight(MDUtils.dpToPx(minHeight, getResources()));
		setMinimumWidth(MDUtils.dpToPx(minWidth, getResources()));
		// Background shape
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - MDUtils.dpToPx(6, getResources()), getHeight()
						- MDUtils.dpToPx(7, getResources()), Config.ARGB_8888);
