...
public class ButtonFloat extends Button{
	...
	public ButtonFloat(Context context, AttributeSet attrs) {
		...
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(MDUtils.dpToPx(sizeIcon, getResources()), MDUtils.dpToPx(sizeIcon, getResources()));
	...
	protected void setDefaultProperties(){
		...
		rippleSize = MDUtils.dpToPx(5, getResources());
...
//		super.setDefaultProperties();
	...
	protected void setAttributes(AttributeSet attrs){
		...
		final boolean animate = attrs.getAttributeBooleanValue(MATERIALDESIGNXML,"animate", false);
			post(new Runnable() {
				...
				@Override
				public void run() {
					showPosition = ViewHelper.getY(ButtonFloat.this) - MDUtils.dpToPx(24, getResources());
	...
	protected void onDraw(Canvas canvas) {
		...
		if (x != -1) {
			...
			Rect dst = new Rect(MDUtils.dpToPx(1, getResources()), MDUtils.dpToPx(2, getResources()), getWidth()-
					MDUtils.dpToPx(1, getResources()), getHeight()- MDUtils.dpToPx(2, getResources()));
