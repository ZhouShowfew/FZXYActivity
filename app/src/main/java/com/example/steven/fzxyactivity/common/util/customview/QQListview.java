package com.example.steven.fzxyactivity.common.util.customview;
...
/**
 * Created by SkyEyes9 on 2016/5/19.
 *
 */
public class QQListview extends ListView{
    ...
    private EditButtonClickListener mEListener;
    ...
    public QQListview(Context context, AttributeSet attrs) {
        ...
        View view = mInflater.inflate(R.layout.item_listview_qq, null);
        mDelBtn = (Button) view.findViewById(R.id.id_item_btn);
        mEditBtn = (Button) view.findViewById(R.id.id_item_btn_edit);
            ...
            switch (action)
            {
                case MotionEvent.ACTION_MOVE:
                    ...
                    mEditBtn.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (mEListener!=null){
                                mEListener.clickEditHappend(mCurrentViewPos);
                                mPopupWindow.dismiss();
                            }
                        }
                    });
